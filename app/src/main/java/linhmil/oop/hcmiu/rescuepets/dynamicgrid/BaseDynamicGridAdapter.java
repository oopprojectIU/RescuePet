...
public abstract class BaseDynamicGridAdapter extends AbstractDynamicGridAdapter {
    ...
    private ArrayList<Pets> mItems = new ArrayList<Pets>();
    ...
    public BaseDynamicGridAdapter(Context context, ArrayList<Pets> items, int columnCount) {
        mContext = context;
        mColumnCount = columnCount;
        init(items);
    }

    private void init(ArrayList<Pets> items) {
        addAllStableId(items);
        this.mItems.addAll(items);
    }


    public void set(ArrayList<Pets> items) {
        clear();
        init(items);
    ...
    public void add(ArrayList<Pets> items) {
        addAllStableId(items);
        this.mItems.addAll(items);
        notifyDataSetChanged();
    }
